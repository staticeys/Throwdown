...
Files are stored locally in your browser using the [Origin Private File System](https://developer.mozilla.org/en-US/docs/Web/API/File_System_API/Origin_private_file_system) (OPFS). This is a browser-native storage API — no server or cloud service involved.
